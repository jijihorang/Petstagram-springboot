...
public class PostController {
    ...
    public ResponseEntity<PostDTO> updatePost(@PathVariable Long postId, @RequestPart("post") PostDTO postDTO, @RequestPart(value = "file", required = false) MultipartFile file) {
        try {
